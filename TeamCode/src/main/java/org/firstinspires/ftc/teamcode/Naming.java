...
public class Naming {
    // Name configuration
    static final String MOTOR_LIFT_NAME = "lift";
    ...
    static final String SERVO_GRABBER_NAME = "grabber";
    static final String SERVO_FOUNDATION_LEFT_NAME = "foundationL";
    static final String SERVO_FOUNDATION_RIGHT_NAME = "foundationR";
    ...
    static final String WEBCAME_0_NAME = "Webcam 1";
